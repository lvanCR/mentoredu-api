...
| HU | Descripción | Endpoint tentativo | Notas |
|---|---|---|---|
| HU03 | Solicitar recuperación de contraseña | `POST /api/v1/auth/forgot-password` | Genera entrada en `password_reset_tokens`. |
| HU26 | Resetear contraseña con token | `POST /api/v1/auth/reset-password` | Valida token, actualiza `password_hash`, invalida sesiones activas. |
