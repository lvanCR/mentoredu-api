...
public interface IResourceService {
    ...
    PagedResponse<ResourceResponse> search(String query, String type, UUID universityId, UUID areaId, UUID careerId, UUID courseId, UUID authorId, Integer resourceYear, int page, int size);
