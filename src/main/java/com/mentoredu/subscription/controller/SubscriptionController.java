package com.mentoredu.subscription.controller;
...
import com.mentoredu.subscription.service.ISubscriptionService;
...
@Tag(name = "Suscripciones", description = "Gestión de suscripciones premium y modelo freemium (US18).")
...
public class SubscriptionController {
    ...
    @GetMapping("/me")
    @Operation(summary = "US18 - Listar mis suscripciones")
    ...
    @Operation(summary = "US18 - Consultar suscripción activa")
    ...
    @PostMapping
    @Operation(summary = "US18 - Crear suscripción")
